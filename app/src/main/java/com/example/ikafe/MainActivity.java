...
public class MainActivity extends AppCompatActivity {
    ...
    public void addMenu(){
        ...
        menuArrayList.add(new Menu(
                ...
                "Minuman",
                "Kopi Hitam",
                "Kopi Hitam dibuat dengan teknik espresso, dimana biji kopo yang digunakan yaitu berasal dari Aceh Gayo jenis Arabika, disajikan dengan gula terpisah",
                "Rp. 10000"));
        menuArrayList.add(new Menu(
                "B02",
                "Minuman",
        ...
        menuArrayList.add(new Menu(
                ...
                "Makanan",
                "Nasi Goreng",
                "Nasi Goreng Ayam yang disajikan dengan Telur Mata Sapi disertai Sate Ayam",
                "Rp. 50000"));
        menuArrayList.add(new Menu(
                "D01",
                "Dessert",
        ...
        menuArrayList.add(new Menu(
                ...
                "Dessert",
                "Black Salad",
                "Potongan buah-buahan segar yang terdiri dari Pepaya, Jambu, Melon, dan Mangga disajikan dengan bumbu rujak kacang pedas dan gula merah",
                "Rp. 30000"));
    }
}
